    ...
    namespace stochprocess {
        ...
        namespace normal {
            ...
            namespace arithmeticbm {
                ...
                inline double sampleStep(const ABM& abm, double x, double dt, double z) {

                    return x + abm.mu * dt + abm.sigma * std::sqrt(dt) * z;
                }

                inline double sampleStep(const ABM& abm, double x, double dt,std::mt19937& gen) {

                    return sampleStep(abm,x,dt,sample(probability::Normal{},gen));
                }

                inline numcpp::objects::Vector samplePath(const ABM& abm, double T, const numcpp::objects::Vector& Z) {
                ...
                inline numcpp::objects::Vector samplePath(const ABM& abm, double T, int numberSteps, std::mt19937& gen) {

                    return samplePath(abm,T,sample(probability::Normal{},gen,numberSteps));
                }

                inline numcpp::objects::Matrix samplePath(const ABM& abm, double T, const numcpp::objects::Matrix& Z) {
                ...
                inline numcpp::objects::Matrix samplePath(const ABM& abm, double T, int numberSteps, int size, std::mt19937& gen) {
                ...
                inline objects::Vector residuals(const std::map<double,double>& data, const ABM& abm) {
